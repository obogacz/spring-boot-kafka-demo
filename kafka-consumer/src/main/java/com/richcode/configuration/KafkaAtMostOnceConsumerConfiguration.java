...
@ConditionalOnBean(AtMostOnceConsumerStrategy.class)
public class KafkaAtMostOnceConsumerConfiguration {

    public static final String SINGLE_EVENT_LISTENER_CONTAINER_FACTORY_BEAN_NAME = "kafkaPurchaseAtMostOnceSingleEventListenerContainerFactory";
    public static final String BATCH_EVENT_LISTENER_CONTAINER_FACTORY_BEAN_NAME = "kafkaPurchaseAtMostOnceBatchEventListenerContainerFactory";
    ...
    ConcurrentKafkaListenerContainerFactory<String, PurchaseEvent> singleEventListenerContainerFactory() {
        ...
        containerFactory.getContainerProperties().setSyncCommits(false);
