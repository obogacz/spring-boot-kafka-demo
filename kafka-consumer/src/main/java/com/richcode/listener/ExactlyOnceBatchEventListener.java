...
public class ExactlyOnceBatchEventListener implements BatchEventListener {
    ...
    @KafkaListener(
        ...
        containerFactory = KafkaExactlyOnceConsumerConfiguration.BATCH_EVENT_LISTENER_CONTAINER_FACTORY_BEAN_NAME)
