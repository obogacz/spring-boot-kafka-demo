...
public class AtLeastOnceSingleEventListener implements SingleEventListener {
    ...
    @KafkaListener(
        ...
        containerFactory = KafkaAtLeastOnceConsumerConfiguration.SINGLE_EVENT_LISTENER_CONTAINER_FACTORY_BEAN_NAME)
